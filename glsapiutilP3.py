...
class glsapiutil2:
    ...
    def PUT( self, xmlObject, url ):
        ...
        req.data = xmlObject
        req.data = req.data.encode('ascii') # converts data to be bytes
        req.get_method = lambda: 'PUT'
        req.add_header('Accept', 'application/xml')
        req.add_header('Content-Type', 'application/xml')
        req.add_header('User-Agent', 'Python-urllib.request/%s' % self.pythonVersion )
    ...
    def deleteObject( self, xmlObject, url):
            ...
            req.add_header('Accept', 'application/xml')
            req.add_header('Content-Type', 'application/xml')
            req.add_header('User-Agent', 'Python-urllib.request/2.4')
...
class glsapiutilP3:
    ...
    def createObject( self, xmlObject, url ):
        ...
        req.add_header('Accept', 'application/xml')
        req.add_header('Content-Type', 'application/xml')
        req.add_header('User-Agent', 'Python-urllib.request/2.6')
